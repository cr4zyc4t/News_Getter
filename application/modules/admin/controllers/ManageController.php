...
class Admin_ManageController extends Zend_Controller_Action
{
	...
	public function doaddcontentAction()
	{
		...
		if ($subcategory_id) {
			...
			$db_col = array('url','title','mp3','wav','video', 'description','author','subcategory_id','sort','time','content','content_1','content_2','content_3','view','like','rank_hot','rank_interest','rank_best','next_content','prev_content','emotion','sexual','human_career', 'created_time');
