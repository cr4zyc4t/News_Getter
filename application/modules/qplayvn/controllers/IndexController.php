...
class Qplayvn_IndexController extends Zend_Controller_Action
{
	...
	public function indexAction()
	{
		...
		$category = new Model_LinkGetContentLegacy;
	...
	public function addlinkAction()
	{
		...
		if($this->_request->isPost()){
			$form = new Qplayvn_Forms_AddLink($_POST);
            if($form->isValid($_POST)){
            	...
            	arr_dump($form->getMessages("sub_category_id"));
            }
        }
