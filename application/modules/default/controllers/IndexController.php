...
class IndexController extends Zend_Controller_Action
{
	...
	public function indexAction()
	{
		...
		$model_content = new Model_Contents;
		if ($type == 'noi-bat') {
			$this->view->selected_ctg_id = -1;

			$this->view->newsList = $model_content->getHighLight(9);
		} elseif ($type == 'tin-moi') {
			$this->view->selected_ctg_id = -2;

			$this->view->newsList = $model_content->getNewest(9);
		}
	}
