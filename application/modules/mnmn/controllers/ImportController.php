...
class MNMN_ImportController extends Zend_Controller_Action
{
...
// 					
	...
	public function getcontentAction()
	{
		...
		try{
			...
			$subcategory_cover = $html->find('div.hero img', 0);
			if ($subcategory_cover) {
				$subcategory_model->update(array("icon" => $subcategory_cover->getAttribute("src") ), "id=$link_get_content[subcategory_id]");
			}
