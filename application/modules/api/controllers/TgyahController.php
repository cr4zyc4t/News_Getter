...
class Api_TgyahController extends Zend_Controller_Action //Thank god you are here!
{
	private $reply = array();
	...
	public function searchAction()
	{
		...
		if ($keyword) {
			...
			$content_model = new Model_Contents;
			$list = $content_model->seachContent($keyword, array(393,394,395,396,397,398,399,400,401,402,403,404),$count, $count*( $page-1 ));
	...
	public function getHighlightAction()
	{
		...
		$this->reply['success'] = TRUE;
		$this->reply['video_list'] = $model_content->getHighLightByCategory(132, 9, 9*( $page-1 ));
	}
